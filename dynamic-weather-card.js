  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return u``;return u`
    ...
    `}renderSunrise(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunrise)return u``;return u`
      <div class="info-item">
        ...
        <span>${No(this.sunData.sunrise,this.config.clockFormat,e.t("am"),e.t("pm"))}</span>
      </div>
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return u``;let o=this.entityAttributes||{},i=Co(this.weather.windSpeed,o,this.config.windSpeedUnit),a=Pi(o,this.config.windSpeedUnit,e.t.bind(e)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Co(this.weather.windGust,o,this.config.windSpeedUnit)} ${a}`;let l=this.config.showWindDirection&&this.weather.windBearing!=null?Gi(this.weather.windBearing):E("wind");return u`
      <div class="info-item">
    ...
    `}renderSunset(){if(!this.config?.showSunriseSunset||!this.sunData?.hasSunData||!this.sunData.sunset)return u``;return u`
      <div class="info-item">
        ...
        <span>${No(this.sunData.sunset,this.config.clockFormat,e.t("am"),e.t("pm"))}</span>
      </div>
    ...
    `}}b([m({type:Object})],Vi.prototype,"weather",void 0),b([m({type:Object})],Vi.prototype,"sunData",void 0),b([m({type:Object})],Vi.prototype,"config",void 0),b([m({type:Object})],Vi.prototype,"entityAttributes",void 0),b([m({type:Number})],Vi.prototype,"fontSize",void 0);customElements.define("weather-details",Vi);var to=Q`
  :host {
    display: block;
  }
...
`;class Yi extends z{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=to;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=eo(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
    ...
    `}}b([m({type:Array})],Yi.prototype,"forecast",void 0),b([m({type:String})],Yi.prototype,"clockFormat",void 0);customElements.define("hourly-forecast",Yi);class Ui extends z{constructor(){super(...arguments);this.forecast=[];this.lang="en"}static styles=to;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=eo(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
      <div class="forecast-container">
    ...
    `}getCustomEntityStates(){if(!this.hass||!this.config.customEntities?.length)return[];return this.config.customEntities.slice(0,3).map((o)=>{let i=this.hass.states[o.entity];if(!i)return null;return{state:i.state,name:o.name||o.entity}}).filter((o)=>o!==null)}setConfig(o){if(!o.entity)throw Error("Please define a weather entity");let i=o.show_hourly_forecast??o.show_forecast;if(this.config={type:"custom:dynamic-weather-card",entity:o.entity,icons_path:o.icons_path,name:o.name,height:o.height||d.height,showFeelsLike:o.show_feels_like!==!1,showWind:o.show_wind!==!1,showWindGust:o.show_wind_gust!==!1,showWindDirection:o.show_wind_direction!==!1,showHumidity:o.show_humidity!==!1,showMinTemp:o.show_min_temp!==!1,showForecast:o.show_forecast===!0,showHourlyForecast:i===!0,showDailyForecast:o.show_daily_forecast===!0,hourlyForecastHours:o.hourly_forecast_hours??d.hourlyForecastHours,dailyForecastDays:o.daily_forecast_days??d.dailyForecastDays,showSunriseSunset:o.show_sunrise_sunset!==!1,showClock:o.show_clock===!0,clockPosition:o.clock_position||d.clockPosition,clockFormat:o.clock_format||d.clockFormat,clockSize:o.clock_size??d.clockSize,showDate:o.show_date===!0,showSeconds:o.show_seconds??d.showSeconds,overlayOpacity:o.overlay_opacity!==void 0?o.overlay_opacity:d.overlayOpacity,language:o.language||d.language,windSpeedUnit:o.wind_speed_unit||d.windSpeedUnit,sunriseEntity:o.sunrise_entity||null,sunsetEntity:o.sunset_entity||null,templowAttribute:o.templow_attribute||null,tapAction:o.tap_action||{action:"more-info"},holdAction:o.hold_action||{action:"none"},doubleTapAction:o.double_tap_action||{action:"none"},timeBackground:o.time_background||void 0,fontSize:o.font_size??d.fontSize,customEntities:o.custom_entities?.length?o.custom_entities.slice(0,3).map((a)=>({entity:typeof a==="string"?a:a.entity,name:typeof a==="string"?void 0:a.name})):[]},this.config.language)e.setLanguage(this.config.language)}fireEvent(o,i={}){let a=new CustomEvent(o,{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(a)}getCardSize(){return 1}render(){if(!this.hass)return u`<div>No Home Assistant connection</div>`;let o=jo(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),i=this.hass.states[this.config.entity],a=Ko(i,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||vo(a),l=`weather-card ${n.type}`,s=this.config.height?`${this.config.height}px`:"200px",r=this.config.timeBackground?.length?$i(this.config.timeBackground):Wi(n),c=r?`background: linear-gradient(135deg, rgb(${r.start.r}, ${r.start.g}, ${r.start.b}), rgb(${r.end.r}, ${r.end.g}, ${r.end.b}));`:"",t=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:d.overlayOpacity};`,g=this.config.showHourlyForecast?this.forecastService.getHourlyForecast(this.config.hourlyForecastHours??d.hourlyForecastHours,o):[],y=this.config.showDailyForecast?this.forecastService.getDailyForecast(this.config.dailyForecastDays??d.dailyForecastDays,o):[];return u`
      ...
      >
        <div class="${l}" style="min-height: ${s}; ${c}; ${t} cursor: pointer;">
