...
`,Ua={sunny:k`
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showWindDirection&&this.weather.windBearing!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return h``;return h`
      <div class="info-item">
    ...
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return h``;let o=this.entityAttributes||{},i=Co(this.weather.windSpeed,o,this.config.windSpeedUnit),a=Pi(o,this.config.windSpeedUnit,e.t.bind(e)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Co(this.weather.windGust,o,this.config.windSpeedUnit)} ${a}`;return h`
      <div class="info-item">
        <span class="info-icon">${E("wind")}</span>
        <span>${i} ${a}${n}</span>
      </div>
