...
`,Ra={sunny:y`
  ...
  `};function C(o,...i){let a=Xa[o];if(typeof a==="function")return a(...i);return a||""}function to(o){if(!o)return"";return Ra[o.toLowerCase()]||""}class ji extends b{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null;this.fontSize=13;this.hass=null}static styles=P`
    :host {
      display: block;
      --dw-font-size: 13px;
    }
