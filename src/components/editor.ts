...
export class DynamicWeatherCardEditor extends LitElement {
  ...
  setConfig(config: WeatherCardEditorConfig): void {
    ...
    this._config = {
      ...
      show_precipitation: DEFAULT_CONFIG.showPrecipitation,
      show_sunrise: DEFAULT_CONFIG.showSunrise,
      show_sunset: DEFAULT_CONFIG.showSunset,
  ...
  private get _schema(): HaFormSchema {
    return [
      ...
      { name: 'show_sunset', selector: { boolean: {} } },
