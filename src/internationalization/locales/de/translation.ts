...
const translation: Translation = {
  ...
  'editor': {
    ...
    'show_precipitation': 'Niederschlag anzeigen',
    'precipitation_entity': 'Niederschlag-Sensor',
    'show_sunrise': 'Sonnenaufgang anzeigen',
    'show_sunset': 'Sonnenuntergang anzeigen',
    ...
    'detail_entity': 'Detail-Entität (UV/Mond/...)',
    'detail_entity_icon': 'Detail-Entität Icon',
    'show_moon': 'Mondphase anzeigen',
    'moon_entity': 'Mond-Entität',
    'time_background': 'Zeit-Hintergrund',
    'time_background_description': 'Zeitbasierte Hintergrundfarben in YAML konfigurieren (time_background).',
    'language': 'Sprache',
